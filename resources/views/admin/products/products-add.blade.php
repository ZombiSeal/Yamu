<div class="admin-container__content">
    ...
    <form class="quiz-add-form" action="{{route('admin.products.addData', ['action'=>'add'])}}" method="post">
        <div class="row">
            <div class="admin-container__col">
                <x-radio class="" type="checkbox" name="isNew" id="1" checked=0>Новинка</x-radio>
                ...
                <div class="admin-container__row">
                    <div class="item">
                        <x-input class="validate number" name="weight" type="text">Вес(г)*</x-input>
                        <div class="input-error"></div>
                    </div>
                    <div class="item">
                        <x-input class="validate number" name="price" type="text">Цена(руб)*</x-input>
                        <div class="input-error"></div>
                    </div>
                    @if(!$sales->isEmpty())
                ...
                <div class="admin-container__row">
                    <div class="item">
                        <x-input class="validate number" name="protein" type="text">Белки*</x-input>
                        <div class="input-error"></div>
                    </div>
                    <div class="item">
                        <x-input class="validate number" name="fats" type="text">Жири*</x-input>
                        <div class="input-error"></div>
                    </div>
                    <div class="item">
                        <x-input class="validate number" name="carbs" type="text">Углеводы*</x-input>
                        <div class="input-error"></div>
                    </div>
                    <div class="item">
                        <x-input class="validate number" name="calories" type="text">кКал*</x-input>
                        <div class="input-error"></div>
                    </div>
                </div>
